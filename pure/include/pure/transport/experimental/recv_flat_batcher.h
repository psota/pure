...
#ifndef RECV_FLAT_BATCHER_H
#define RECV_FLAT_BATCHER_H

#if FLAT_BATCHER_RECV_VERSION == 1
#warning "INCLUDING FLAT_BATCHER_RECV_VERSION 1"
#include "pure/transport/experimental/v1/recv_flat_batcher_v1.h"
#endif

#if FLAT_BATCHER_RECV_VERSION == 2
#warning "INCLUDING FLAT_BATCHER_RECV_VERSION 2"
