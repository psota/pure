// Author: James Psota
// File:   rand_jacobi_pure_no_send_recv.cpp 
...
void bench(int iter, int cls_per_rank, int my_rank, int n_ranks,
    ...
    for (auto it = 0; it < iter; ++it) {
        ...
        if (it == 0) {
            ...
            VoidPureContinuation f_cont      = [num_doubles, a, temp,
                                           owning_rank](void* recv_buf,
                                                        int   payload_count,
                                                        PureRTContExeMode m,
